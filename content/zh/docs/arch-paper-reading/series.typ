#let arch-paper-reading-series = (
  ...
  chapters: (
    (
      ...
      title: "基于 LA-PC 的 Data Cache Preloading",
    ...
    (
      ...
      title: "用运行时反馈调节硬件预取器：Feedback Directed Prefetching",
    ...
    (
      ...
      title: "Region-level spatial pattern：Spatial Memory Streaming",
    ...
    (
      id: "colt",
      title: "利用 intermediate contiguity 扩大 TLB reach：CoLT",
    ...
    (
      id: "store-sets",
      title: "Violation-driven memory dependence prediction：Store Sets",
